...
from knowledge.features.extractors.fomc import FOMCFeatureExtractor


class FOMCEvent(MacroEvent):
    """Lesson-building logic for FOMC rate decisions."""

    event_type = "FOMC"
    lesson_version = "fomc_gold_v1"
    condition_columns: ClassVar[list[str]] = ["fomc_decision"]
    knowledge_version = "fomc_gold_summary_v1"

    calendar: ClassVar[type[FOMCCalendarConnector]] = FOMCCalendarConnector
    ...
    def __init__(self) -> None:
        ...
        self._extractor = FOMCFeatureExtractor()
    ...
    def lesson_text(self, lesson: dict[str, object]) -> str:
        ...
        fomc_rate = lesson["fomc_rate"]
        decision = lesson["fomc_decision"]
        return (
            f"After the FOMC set rates at {fomc_rate}% ({decision}) "
